...
def write_middle(f, pseudo_dir, prefix, nat, ntyp, ecutwfc, ecutrho):
...
def write_pwx(prefix, skp, pseudo_dir, ecutwfc, ecutrho, pseudo_dict, nq, nelec):
    #
    # Lattice information
    #
    ...
    if not os.path.isfile("rx.in"):
        with open("rx.in", 'w') as f:
            ...
            write_middle(f, pseudo_dir, prefix, nat, ntyp, ecutwfc, ecutrho)
